...
print("Eating")
print("Watching TV, Anime,YouTube,Animal Planet, Discovery Planet")
print("Planting")
print("Taking care of animals")
print("Takking picture of sunset, natures,and etc")
print("cooking")
print("editing")
print("discovering new things,new hobby")